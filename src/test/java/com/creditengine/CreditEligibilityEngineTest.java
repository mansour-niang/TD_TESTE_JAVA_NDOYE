...
class CreditEligibilityEngineTest {
    ...
    private final CreditEligibilityEngine engine = new CreditEligibilityEngine(clientId -> false);

    @Test
    void rejette_quand_le_reste_a_vivre_est_strictement_inferieur_a_100000() {
        LoanApplication application = new LoanApplication("client-1", 200_000, 150_001, 500_000, 12, false);
    ...
    void approuve_quand_le_reste_a_vivre_est_exactement_100000() {
        ...
        LoanApplication application = new LoanApplication("client-2", 140_000, 40_000, 7_000, 12, false);
    ...
    void approuve_quand_le_reste_a_vivre_est_superieur_a_100000() {
        ...
        LoanApplication application = new LoanApplication("client-3", 400_000, 100_000, 12_000, 12, false);
    ...
    void rejette_quand_le_taux_d_endettement_depasse_33_pourcent() {
        ...
        LoanApplication application = new LoanApplication("client-4", 300_000, 90_000, 120_000, 12, false);
    ...
    void approuve_quand_le_taux_d_endettement_est_exactement_33_pourcent() {
        ...
        LoanApplication application = new LoanApplication("client-5", 300_000, 89_000, 120_000, 12, false);
    ...
    void approuve_un_fonctionnaire_a_38_pourcent_d_endettement_alors_qu_un_client_standard_serait_rejete() {
        ...
        LoanApplication application = new LoanApplication("client-6", 300_000, 104_000, 120_000, 12, true);
